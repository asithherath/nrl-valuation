  ...
  return(
      ...
      <div style={{maxWidth:1200,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",gap:20}}>
        <div>
          <div style={{display:"flex",alignItems:"flex-end",gap:14,marginBottom:6,flexWrap:"wrap"}}>
            ...
            <span style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:14,color:"#6a7a96",letterSpacing:3,paddingBottom:5}}>V23 · ALL CLUBS</span>
          </div>
    ...
    <div style={{maxWidth:1200,margin:"0 auto",padding:"0 24px"}}>
      ...
      <div style={{marginTop:14,fontSize:10,color:"#6a7590",letterSpacing:1,lineHeight:1.9}}>
        METHODOLOGY v23: {SEED_PLAYERS.length} players across 17 NRL clubs. value = band_min + composite_score × (band_max − band_min) per position. Four weighted sub-scores (0–1). Cap = ${SALARY_CAP.toLocaleString()} (2026). Salary estimates from public reporting. Third-party deals excluded.
      </div>
    </div>
    </div>
  );
